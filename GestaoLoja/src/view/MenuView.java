...
public final class MenuView extends javax.swing.JFrame {
    ...
    private static void exibirMenuPrincipal() {
        try {
            ...
            menuView = new MenuView(connection);
            menuView.addWindowListener(new java.awt.event.WindowAdapter() {
                @Override
                public void windowClosed(java.awt.event.WindowEvent windowEvent) {
                    exibirMenuPrincipal(); // Exibir o menu principal quando a janela for fechada
                }
            });
    ...
    private void jMenuItemFuncionariosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemFuncionariosActionPerformed
        try {
            CadastroFuncionarioView funcionarioView = new CadastroFuncionarioView();
            funcionarioView.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE); // Definir operação de fechamento para DISPOSE_ON_CLOSE
            funcionarioView.addWindowListener(new java.awt.event.WindowAdapter() {
                @Override
                public void windowClosed(java.awt.event.WindowEvent windowEvent) {
                    exibirMenuPrincipal(); // Exibir o menu principal quando a janela for fechada
                }
    ...
    private void jMenuItemUsuariosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemUsuariosActionPerformed
        try {
              ...
              usuarioView.addWindowListener(new java.awt.event.WindowAdapter() {
                  @Override
                  public void windowClosed(java.awt.event.WindowEvent windowEvent) {
                      exibirMenuPrincipal();
                  }
    ...
    private void jMenuItemProdutosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemProdutosActionPerformed
        try {
            CadastroProdutoView produtoView = new CadastroProdutoView();
            produtoView.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE); // Definir operação de fechamento para DISPOSE_ON_CLOSE
            produtoView.addWindowListener(new java.awt.event.WindowAdapter() {
                @Override
                public void windowClosed(java.awt.event.WindowEvent windowEvent) {
                    exibirMenuPrincipal(); // Exibir o menu principal quando a janela for fechada
                }
    ...
    private void jMenuItemCaixaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemCaixaActionPerformed
        try {
            CaixaView caixaView = new CaixaView();
            caixaView.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE); // Definir operação de fechamento para DISPOSE_ON_CLOSE
            caixaView.addWindowListener(new java.awt.event.WindowAdapter() {
                @Override
                public void windowClosed(java.awt.event.WindowEvent windowEvent) {
                    exibirMenuPrincipal(); // Exibir o menu principal quando a janela for fechada
                }
    ...
    private void jMenuItemCompraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemCompraActionPerformed
        try {
            CompraView compraView = new CompraView();
            compraView.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE); // Definir operação de fechamento para DISPOSE_ON_CLOSE
            compraView.addWindowListener(new java.awt.event.WindowAdapter() {
                @Override
                public void windowClosed(java.awt.event.WindowEvent windowEvent) {
                    exibirMenuPrincipal(); // Exibir o menu principal quando a janela for fechada
                }
